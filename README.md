...
Die [GitHub-Pages-Version](https://kevinspaeth89-cmyk.github.io/cnc-factory-phaser/) im Browser öffnen. Ein neues Spiel startet ohne Maschinen oder Material. Über **Betrieb** lassen sich Maschinen kaufen, Bediener einstellen und zuweisen sowie Lager und Halle ausbauen. Der erste Tipp auf eine Maschine in der Halle öffnet eine kleine Vorschau direkt über ihrem Stellplatz; ein zweiter Tipp auf dieselbe Maschine oder **Nahaufnahme öffnen** zeigt die Maschinenansicht. Ein Tipp auf eine andere Maschine wechselt die Vorschau. **Aufträge** bietet wechselnde Angebote für Drehen und Fräsen. **Maschine** bietet sortenbezogenen Materialeinkauf, Werkzeugwechsel, Wartung, Upgrades und Entscheidungen bei Störungen. **Tempo** enthält 1×/2×/5×/10×; **Pause** hält die gesamte Spielzeit an.
